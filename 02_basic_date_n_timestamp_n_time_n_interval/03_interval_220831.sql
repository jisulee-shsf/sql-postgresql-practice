...
select pg_typeof(to_date('2022-01-01', 'yyyy-mm-dd') + 2) as date_01 -- type : date
	, to_date('2022-01-01', 'yyyy-mm-dd') + interval '2 days' as date_to_timestamp_01 -- ret : 2022-01-03 00:00:00.000
	, pg_typeof(to_date('2022-01-01', 'yyyy-mm-dd') + interval '2 days') as date_to_timestamp_02 -- type : timestamp
	, to_date('2022-01-01', 'yyyy-mm-dd') - interval '2 days' as date_to_timestamp_03 -- ret : 2021-12-30 00:00:00.000
	, pg_typeof(to_date('2022-01-01', 'yyyy-mm-dd') - interval '2 days') as date_to_timestamp_04; -- type : timestamp
	
-- Q1-3. to_date - to_date = integer 연산 확인
select to_date('2022-01-01', 'yyyy-mm-dd') - to_date('2022-01-03', 'yyyy-mm-dd') as interval_01 -- ret : -2
	, pg_typeof(to_date('2022-01-01', 'yyyy-mm-dd') - to_date('2022-01-03', 'yyyy-mm-dd')) as interval_02; -- type : integer
select to_date('2022-01-03', 'yyyy-mm-dd') - to_date('2022-01-01', 'yyyy-mm-dd') as interval_03 -- ret : 2
...
select to_timestamp('2022-01-01', 'yyyy-mm-dd hh24:mi:ss') + interval '2' as timestamp_02 -- ret : 2022-01-01 00:00:02.000 +0900
	, to_timestamp('2022-01-01', 'yyyy-mm-dd hh24:mi:ss') + interval '+ 2' as timestamp_03 -- ret : 2022-01-01 00:00:02.000 +0900
	, to_timestamp('2022-01-01', 'yyyy-mm-dd hh24:mi:ss') + interval '2 days' as timestamp_04 -- ret : 2022-01-03 00:00:00.000 +0900
	, to_timestamp('2022-01-01', 'yyyy-mm-dd hh24:mi:ss') + interval '2' day as timestamp_05; -- ret : 2022-01-03 00:00:00.000 +0900
	
-- Q2-3. to_timestamp - to_timestamp = interval 연산 확인
select to_timestamp('2022-01-01', 'yyyy-mm-dd hh24:mi:ss') 
	- to_timestamp('2022-01-03', 'yyyy-mm-dd hh24:mi:ss') as interval_05  -- ret : -2 days
...
select to_timestamp('2022-01-03', 'yyyy-mm-dd hh24:mi:ss') 
	- to_timestamp('2022-01-01', 'yyyy-mm-dd hh24:mi:ss') as interval_07  -- ret : 2 days
